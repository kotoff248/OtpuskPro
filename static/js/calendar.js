(function () {
    ...
    function collectCalendarContext(filtersForm, signal) {
        ...
        const context = {
            ...
            modulePreview: document.getElementById("vacation-module-preview"),
            moduleLabel: document.getElementById("vacation-module-label"),
            moduleReason: document.getElementById("vacation-module-reason"),
            moduleAction: document.getElementById("vacation-module-action"),
            moduleAlternatives: document.getElementById("vacation-module-alternatives"),
            moduleAlternativesList: document.getElementById("vacation-module-alternatives-list"),
